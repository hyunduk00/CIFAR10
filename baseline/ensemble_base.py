...
if __name__ == '__main__':
    ...
    for s in range(model_num):
        ...
        for i in range(s+1):
            ...
            model.load_state_dict(torch.load(f"./weights/%s/resnet18_cifar10_%f_%d.pth" % (experiment, lr, i)))  # Load the trained weights
        ...
        print('Accuracy of the %s ensemble on the 10000 test images: %f %%' % (s, 100 * correct / total))