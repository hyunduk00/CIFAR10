...
if __name__ == "__main__":
    ...
    for s in range(model_num):
        ...
        model = timm.create_model(student_model_name, pretrained=True, num_classes=10)
        ...
        PATH = './weights/%s/%s_cifar10_%f_%d.pth' % (experiment, student_model_name, lr, seed_number)
